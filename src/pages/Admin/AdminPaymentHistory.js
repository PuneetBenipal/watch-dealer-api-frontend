...
const AdminUsers = () => {
    ...
    const applyFilters = useCallback(() => {
        ...
        if (filtered.length === 0) {
            ...
            Toast.success(`Found ${filtered.length} user(s) matching filters`)
        }
    ...
    const fetchPaymentHistory = async (userId) => {
        try {
            const response = await API.get(`/api/admin/users/${userId}/payments`);
    ...
    const handleEditUser = (user) => {
        ...
        fetchPaymentHistory(user.id || user._id);
    };
                        ...
                        <div className="px-6 py-4">
                            <div className="space-y-4">
                                <div className="flex justify-between items-center">
                                    ...
                                    <button
                                        onClick={() => fetchPaymentHistory(selectedUser?.id || selectedUser?._id)}
